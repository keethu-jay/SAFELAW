...
def split_into_paragraphs(text_block, author, opinion_type, is_lead):
    ...
    for k in range(1, len(parts), 2):
        ...
        #    Start with a coarse default and then try to refine using YAML patterns.
        ...
        # If not facts, see if this looks like a "history of lower court" paragraph
        ...
        # Heuristic: conclusion markers, often towards the end of a judgment.
        # This is intentionally brittle – different drafting styles will break it.
        ...
        chunks.append({
            "para_number": para_num,          # Neutral citation paragraph number
            "content_text": content,
            "author_name": author,           # Which Lord / Lady is speaking
            "opinion_type": opinion_type,    # majority / concurring / dissenting
            "section_type": section_type,    # facts / history_lower_court / analysis / conclusion
            "has_citation": has_citation,
            "cited_cases": citations_found   # List like ['[2024] UKSC 24']
        })
