...
DEFAULT_CSV = BACKEND_DIR / "testing_scripts" / "output" / "semantic_comparison_input.csv"
...
def main():
    ...
    out_csv = BACKEND_DIR / "testing_scripts" / "output" / "semantic_comparison_results.csv"
