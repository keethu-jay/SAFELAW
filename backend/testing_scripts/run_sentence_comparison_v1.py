#!/usr/bin/env python3
# v1: label-filtered only. Same role as test text.
# Uses corpus_documents_mini_sentences_indiv_class.
# Out: testing_scripts/output/Classification_Comparison_sentences_v1_label_filtered.tsv
...
def get_text_v1(idx, court_opinion, file_name, test_para, test_label, case_metadata, get_case_summary):
...
def main():
    ...
    run(
        ...
        out_suffix="v1_label_filtered",
        get_text_to_embed=get_text_v1,
        supabase=supabase,
        model=model,
